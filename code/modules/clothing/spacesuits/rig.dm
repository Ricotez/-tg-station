...
/obj/item/clothing/head/helmet/space/rig/atmos
	...
	desc = "A special helmet designed for work in a hazardous, low-pressure environment. Has radiation shielding. Assigned to the Atmospherics division."
	icon_state = "rig0-atmospherics"
	color = "atmospherics"

/obj/item/clothing/suit/space/rig/atmos
	name = "atmospherics hardsuit"
	desc = "A special suit that protects against hazardous, low pressure environments. Has radiation shielding. Assigned to the Atmospherics division."
