...
/*
	Most of the new overlay-based human rendering system here is RemieRichards' work. I merely adapted it for the update to a datum-based organ system. |- Ricotez
*/
