...
/datum/species/proc/spec_attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone, var/datum/organ/limb/affecting, var/hit_area, var/intent, var/datum/organ/limb/target_limb, target_area, var/mob/living/carbon/human/H)
	...
	if(!affecting.exists()) //If the targeted limb does not exist, only display a message and return.
